...
/**
 * Created by Leila Sa3eed on 10/04/2015.
 */
public class SendRequestService extends AsyncTask<String, String, String> {
    final String base = Application.getAppContext().getString(R.string.host_base_url);
    final String path = Application.getAppContext().getString(R.string.sendRequest_service);
